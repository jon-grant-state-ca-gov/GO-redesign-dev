...
```html
  ...
  <div class="mobile">
    <button
      ...
      <svg
        ...
        aria-label="California grizzly bear with star above its head.">
        <path
      ...
      <svg
        aria-label="Two horizontal lines"
        class="menu-icon"
        focusable="false"
        viewBox="0 0 32 32">
  ...
  <div class="logo">
    <figure>
      <a href="https://www.gov.ca.gov/">
        <img
          src="../src/images/gov-branding.svg"
  ...
  <div class="navigation">
    <nav>
      <span class="sr-only" wiid="N298">Menu</span>
      <ul class="navlinks">
        ...
        <li class="search">
          <form
            ...
            action="search"
            role="search">
            <label for="close_search" id="label_close_search">
              <span class="sr-only">Close the search box</span>
            </label>
            <button
              id="close_search"
              class="ca-gov-close-icon-small"
              aria-label="Close the search box"></button>
            ...
            <input
              ...
              name="q" />
            <label for="search-submit" id="label_search-submit">
              <span class="sr-only">Submit the search form</span>
            </label>
            <button
              type="submit"
